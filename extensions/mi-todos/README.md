...
| **Browse MiToDos** | See every MiToDos file, scan open vs. done counts, inspect file contents, edit or delete tasks, toggle task state, and move tasks between MiToDos sections. |
