...
| **Browse MiToDos** | See every MiToDos file, scan open vs. done counts, inspect file contents, edit or delete tasks, toggle task state, move tasks between MiToDos sections, and rename or delete project files. |
